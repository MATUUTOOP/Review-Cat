...
│   │   ├── director.sh     # Main Director daemon (heartbeat loop)
...
9. **Merge** — If validation passes, merge PR and close issue.
...
7. **Creates a PR** — via GitHub MCP, linking `Closes #<issue-number>`.
